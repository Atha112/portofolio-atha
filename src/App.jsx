...
const SupabaseIcon = (p) => (
  <svg {...p} viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
    <path d="M3.5 6.5C3.5 5.67 4.17 5 5 5h14c.83 0 1.5.67 1.5 1.5v11c0 .83-.67 1.5-1.5 1.5H5c-.83 0-1.5-.67-1.5-1.5v-11Z" />
    <path d="M6.5 8.5h11v2h-11z" fill="white" />
    <path d="M6.5 13.5h5v2h-5z" fill="white" />
    <path d="M12.5 11.5h5v2h-5z" fill="white" />
  </svg>
);
const VercelIcon = (p) => (
  <svg {...p} viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
...
function ToolsSection() {
  const techStack = [
    { name: 'React', icon: Code2, color: '#61dafb', desc: 'UI Library' },
    { name: 'Tailwind CSS', icon: Package, color: '#38bdf8', desc: 'Utility-first CSS' },
    { name: 'Supabase', icon: SupabaseIcon, color: '#3ecf8e', desc: 'Backend as a Service' },
    { name: 'Vercel', icon: VercelIcon, color: '#ffffff', desc: 'Deployment Platform' },
  ];
    ...
    <section id="tools" className="py-16 sm:py-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
      ...
      <div className="grid gap-10 lg:grid-cols-2">
        <AnimatedSection className="space-y-6">
          <div>
            <p className="text-sm uppercase tracking-[0.24em] text-[#a78bfa] mb-2">Tech Stack</p>
            <h3 className="text-xl sm:text-2xl font-semibold text-white">
              Tools saya untuk membangun aplikasi
            </h3>
          </div>

          <StaggerContainer className="grid grid-cols-2 gap-4 sm:gap-6" staggerDelay={0.15}>
            {techStack.map((tool) => (
        ...
        <AnimatedSection className="space-y-6">
          <div>
            <p className="text-sm uppercase tracking-[0.24em] text-[#a78bfa] mb-2">Tools</p>
            <h3 className="text-xl sm:text-2xl font-semibold text-white">
              Workflow dan pengelolaan proyek
            </h3>
          </div>
